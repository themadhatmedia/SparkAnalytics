        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::textarea('other_featured_description', null, ['class' => 'form-control summernote-simple', 'placeholder' => __('Enter Description'), 'id'=>'']) }}
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::text('other_feature_buy_now_link', null, ['class' => 'form-control','required'=>'required', 'placeholder' => __('Enter Link')]) }}
                </div>
            </div>
