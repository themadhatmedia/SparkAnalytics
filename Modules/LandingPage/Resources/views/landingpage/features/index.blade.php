                        ...
                        <div class="card-header">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="{{ route('feature_create') }}" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal" data-bs-toggle="tooltip"
                                        data-bs-whatever="{{ __('Create Feature') }}" class="btn btn-sm btn-primary">
                                                        ...
                                                        <span>
                                                            <div class="action-btn bg-primary ms-2">
                                                                <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                                    ...
                                                                    data-bs-whatever="{{ __('Edit Feature') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('highlight_feature_heading', $settings['highlight_feature_heading'], ['class' => 'form-control','required'=>'required', 'placeholder' => __('Enter Link')]) }}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('highlight_feature_description', $settings['highlight_feature_description'], ['class' => 'form-control','required'=>'required', 'placeholder' => __('Enter Link')]) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="logo-content mt-4">
                                            <img id="image1"
                                                ...
                                                class="big-logo img_setting" width="450px">
                                        </div>
                                        <div class="choose-files mt-5">
                                            <label for="highlight_feature_image">
                                                ...
                                                <input type="file" name="highlight_feature_image"
                                                    ...
                                                    data-filename="highlight_feature_image" required>
                                            </label>
                                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="{{ route('features_create') }}" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal" data-bs-toggle="tooltip"
                                        data-bs-whatever="{{ __('Create Features Block') }}"
                                                        ...
                                                        <span>
                                                            <div class="action-btn bg-primary ms-2">
                                                                <a href="#"
                                                                    ...
                                                                    data-bs-whatever="{{ __('Edit Feature Block') }}">
