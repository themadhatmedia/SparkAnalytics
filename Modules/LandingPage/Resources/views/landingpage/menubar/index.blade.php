...
<link rel="stylesheet" href="{{asset('Modules/LandingPage/Resources/assets/js/plugins/summernote/summernote-bs4.css')}}">
@endpush
                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-bs-toggle="modal" data-url="{{ route('custom_page.create') }}" data-bs-target="#exampleModal" data-bs-toggle="tooltip" data-bs-whatever="{{__('Create Page')}}"  class="btn btn-sm btn-primary">
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="action-btn bg-primary ms-2">
                                                                        ...
                                                                        data-bs-toggle="modal" data-bs-target="#exampleModal" data-url="{{ route('custom_page.edit',$key) }}"  data-bs-whatever="{{__('Edit Page')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                                                                ...
                                                                @if($value['page_slug'] != 'terms_and_conditions' && $value['page_slug'] != 'about_us' && $value['page_slug'] != 'privacy_policy')
                                                                    ...
                                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['custom_page.destroy', $key],'id'=>'delete-form-'.$key]) !!}
                                                                        ...
                                                                        <a href="#" class="mx-3 btn btn-sm align-items-center show_confirm" data-bs-toggle="tooltip" title="{{__('Delete')}}" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$key}}').submit();">
