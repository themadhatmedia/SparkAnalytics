    ...
    <div class="body">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                {{Form::text('menubar_page_name',$page['menubar_page_name'],array('class'=>'form-control font-style','placeholder'=>__('Enter Plan Name'),'required'=>'required', $page['page_slug'] == 'terms_and_conditions' || $page['page_slug'] == 'privacy_policy' ? 'disabled' : ''  ))}}
            </div>
            ...
            <div class="col-lg-3 col-xl-3 col-md-3">
                <div class="form-check form-switch ml-1">
                    ...
                    <label class="form-check-label f-w-600 pl-1" for="page_content">
                        {{ 'Page Content' }}
                    </label>
                </div>
            </div>
            ...
            <div class="col-lg-2 col-xl-2 col-md-2">
                <div class="form-check form-switch ml-1">
                    ...
                    <label class="form-check-label f-w-600 pl-1" for="page_url">
                        {{ 'Page URL' }}
                    </label>
                </div>
            </div>

            <div class="form-group col-md-12 page_content mt-3">
            ...
            <div class="form-group col-md-12 page_url mt-3 d-none">
