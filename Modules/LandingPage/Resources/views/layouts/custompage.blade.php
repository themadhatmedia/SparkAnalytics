@php
    ...
    $logo_path = Utility::get_file('uploads/landing_page_image');
    $logo = url($logo_path) . '/';
...
<head>
    <title>{{ $setting['header_text'] ? $setting['header_text'] : config('app.name', 'AnalyticsGo') }}</title>
    <!-- Meta -->
    <meta charset="utf-8" />
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active"
                                href="{{ url('/') }}#home">{{ $settings['home_title'] }}</a>
                        </li>
