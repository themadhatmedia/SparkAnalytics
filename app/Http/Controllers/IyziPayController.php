...
class IyziPayController extends Controller
{
    public function initiatePayment(Request $request)
    {
        ...
        $price = (float)$plan->{$request->iyzipay_payment_frequency . '_price'};
        ...
        if($price <= 0)
        {
            ...
            $assignPlan = $this->assignPlan($plan->id,$authuser->id,$request->iyzipay_payment_frequency);
        ...
        try {
            ...
            return redirect()->route('plans')->with('errors', $e->getMessage());
        }
    }
