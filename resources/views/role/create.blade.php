{{Form::open(array('url'=>'store/roles','method'=>'post','class'=>'needs-validation','novalidate'))}}
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                @if(!empty($permissions))
                    ...
                    <table class="table">
                        <tr>
                            <th>
                                <input type="checkbox" class="form-check-input isscheck" name="checkall" id="checkall">
                                <label for="" class="custom-control-label font-weight-500">{{ __('Select All') }}</label>
                            </th>
                        ...
                        @foreach($modules as $module)
                            <tr>
                                <td>
                                    <input type="checkbox" class="form-check-input align-middle ischeck"
