                ...
                languages: {
                    'en': {
                        ...
                        settings_modal: {
                            ...
                            blocks: [{
                                title: ''+parsed.cookie_title+' 📢',
                                description: ''+parsed.cookie_description+'<a href="#" class="cc-link">privacy policy</a>.'
                            }, {
                                ...
                                description: ''+parsed.more_information_description+' <a class="cc-link" target="blank" href="'+parsed.contactus_url+'">contact us</a>.',
                            }]
                        }
                    }
                }
