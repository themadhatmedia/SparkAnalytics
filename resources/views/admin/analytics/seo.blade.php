   ...
   <div class="select-box">
    ...
    <div class="">
      <a class="btn btn-primary" onclick="share_setting('seo');" data-bs-toggle="modal"  data-bs-target="#share_seo_report"><span>
        <i class="ti ti-settings text-white" data-bs-toggle="tooltip" data-bs-original-title="{{__('Share Report Setting')}}"></i></span></a>
    </div>
    @endif
                  ...
                  <div class=" ">
                      <ul class="nav nav-pills nav-fill row" id="pills-tab" role="tablist">
                          ...
                          <li class="nav-item col-sm-1" role="presentation">
                              <button class="nav-link seo-analytics {{ ($i == 0) ? ' active' : '' }}" id="pills-tab-2" data-value="{{$key}}"  onclick="get_seo_data()" data-bs-toggle="pill" data-bs-toggle="pill"
    ...
    <ul class="nav nav-pills nav-fill row" id="pills-tab" role="tablist">
      ...
      @foreach($metric_option as $key => $val)
        <li class="nav-item col-md-3" role="presentation">
          @if($i==1)
          <div class="card nav-link seo-card-metrics active" id="{{$key}}" data-bs-toggle="pill"
                data-bs-target="#channel-chart-{{$i}}"  type="button">
          @else
          <div class="card nav-link seo-card-metrics" id="{{$key}}" data-bs-toggle="pill"
                data-bs-target="#channel-chart-{{$i}}" data-id="{{$key}}" type="button">
          @endif
            <div class="card-body px-lg-5">
              <h4 id="seo_metric_data_{{$key}}">0</h4>
              <h5>{{$val}}</h5>
            </div>
          </div>
