...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/register/{ref_id?}/{lang?}', [RegisteredUserController::class, 'showregisterForm'])->name('register');
...
Route::get('forgot-password/{lang?}', [PasswordResetLinkController::class, 'showforget_passwordForm'])
                ->name('password.request');
