    ...
    ! function (e) {
        ...
        class f {
            ...
            santizeField(e, t) {
                ...
                return t && (n.id = e.id && `${e.id}-${t}`, n.name = e.name && `${e.name}-${t}`), n.className = Array.isArray(e.className) ? s.f.unique(e.className.join(" ").split(" ")).join(" ") : e.className || e.class || null, delete n.class, e.values && (e.values = e.values.map(e => s.f.trimObj(e))), s.f.trimObj(n)
            }
            getElement(e) {
            ...
            render(e = null, t = 0) {
                ...
                if (r.formData) {
                    ...
                    const e = s.f.markup("div", r.messages.noFormData, {
                ...
                render: (n, r = {}) => {
                    if (t.instance) {
                        ...
                        o.options = Object.assign({}, o.options, r, {
                            formData: o.parseFormData(n)
                        }), e.each(n => t.instance.render(e[n], n))
                    }
                },
